...
namespace Afpetit.Controllers
{
    public class CommandesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdCommande,IdUtilisateur,IdRestaurant,DateCommande,IdEtatCommande,Prix")] Commande commande)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdCommande,IdUtilisateur,IdRestaurant,DateCommande,IdEtatCommande,Prix")] Commande commande)
        {
            if (ModelState.IsValid)
            {
